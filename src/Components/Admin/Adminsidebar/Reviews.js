											...
											<tbody>
												<tr>
													...
													<td>
														...
														<td>3 Nov 2019 <br></br><small>09.59 AM</small></td>
													<td class="text-right">
														<div class="actions">
												...
												<tr>
													...
													<td>
														...
														<td>2 Nov 2019<br></br> <small>08.50 AM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
												...
												<tr>
													...
													<td>
														...
														<td>1 Nov 2019<br></br> <small>02.59 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
												...
												<tr>
													...
													<td>
														...
														<td>27 Sep 2019 <br></br><small>03.40 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
												...
												<tr>
													...
													<td>
														...
														<td>24 Sep 2019 <br></br><small>04.38 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
												...
												<tr>
													...
													<td>
														...
														<td>22 Aug 2019 <br></br><small>01.50 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
												...
												<tr>
													...
													<td>
														...
														<td>21 Jul 2019 <br></br><small>05.50 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
												...
												<tr>
													...
													<td>
														...
														<td>16 Jun 2019 <br></br><small>04.50 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
												...
												<tr>
													...
													<td>
														...
														<td>11 Mar 2019 <br></br><small>05.55 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="/admin/profile" class="avatar avatar-sm mr-2"><img class="/adminavatar-img rounded-circle" src="/adminassets/img/patients/patient10.jpg" alt="User Image"/></a>
													...
													<td>
														...
														<td>15 Feb 2019 <br></br><small>07.30 PM</small></td>
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-danger-light" data-toggle="modal" href="#delete_modal">
																<i class="fe fe-trash"></i> Delete
